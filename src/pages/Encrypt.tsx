...
export default function Encrypt() {
  ...
  const processText = () => {
    ...
    if (_advanced) {
      _setOutput(hashUtil.encryptAdvance(_input.trim(), _secret.trim()))
      return
    }

    _setOutput(hashUtil.encrypt(_input.trim(), _secret.trim()))
  }
        ...
        <div className="input-group">
          ...
          <div className="radio-group">
            <label className="radio-option">
              <input type="radio" name="encryptionMode" checked={!_advanced} onChange={() => _setAdvanced(false)} />
              <span>Basic</span>
            </label>
            <label className="radio-option">
              <input type="radio" name="encryptionMode" checked={_advanced} onChange={() => _setAdvanced(true)} />
